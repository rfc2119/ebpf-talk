...
<!-- .slide: data-background-color="#000000" data-background-transition="none" data-background-image="img/system-call-overview-1.png" data-background-size="100%" data-background-opacity="0.3"-->
#### Transitioning To Kernel Space

-v-

<!-- .slide: data-background-color="#000000" data-background-transition="none" data-background-image="img/system-call-overview-1.png" data-background-size="100%"-->
...
slides @ [slides.***REMOVED***.me/ebpf](https://slides.***REMOVED***.me/ebpf)